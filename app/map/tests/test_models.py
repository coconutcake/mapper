...
class MapCase(TestCase):
    ...
    def model_obj_payload_gen(self):
        ...
        while True:
            ...
            # Foreign keys
            department_model = map.models.Department
            department_fk = department_model.objects.create(name=string_gen.__next__(), description=string_gen.__next__())
